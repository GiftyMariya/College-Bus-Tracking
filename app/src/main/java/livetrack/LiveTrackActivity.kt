...
import com.pixieium.austtravels.auth.databinding.ActivityLiveTrackBinding
...
class LiveTrackActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    override fun onDestroy() {
        try {
            ...
            val intent = Intent(this, com.pixieium.austtravels.auth.SignInActivity::class.java)
